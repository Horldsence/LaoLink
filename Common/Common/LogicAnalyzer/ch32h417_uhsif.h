...
#define DEF_UHSIF_SUCCESS                0x00 /* The initialization related to UHSIF was successful */
 ...
 *          water_mark_value: 0 ~ 0x3fff(When sending, it indicates the number of remaining words to be sent in the buffer; 
...
extern void UHSIF_Set_Para(uint8_t logic_bit, uint8_t logic_div);
