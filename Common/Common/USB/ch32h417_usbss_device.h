...
extern __attribute__ ((aligned(4))) uint8_t USBSS_EP1_Tx_Buf[ DEF_USB_EP1_SS_SIZE ];
extern __attribute__ ((aligned(4))) uint8_t USBSS_EP1_Rx_Buf[ DEF_USB_EP1_SS_SIZE ];
// extern __attribute__ ((aligned(32))) uint8_t USBSS_EP2_Tx_Buf[ DEF_USB_EP2_SS_SIZE*DEF_ENDP2_IN_BURST_LEVEL*DEF_UHSIF_TXBUF_CNT  ];     /*端点1上传缓冲区大小*/


extern __attribute__ ((aligned(32),section(".da1"))) uint8_t USBSS_EP2_Tx_Th0_Buf[ DEF_USB_EP2_SS_SIZE*DEF_ENDP2_IN_BURST_LEVEL*DEF_UHSIF_TXBUF_CNT  ];     /*端点1上传缓冲区大小*/
extern __attribute__ ((aligned(32),section(".da1"))) uint8_t USBSS_EP2_Tx_Th1_Buf[ DEF_USB_EP2_SS_SIZE*DEF_ENDP2_IN_BURST_LEVEL*DEF_UHSIF_TXBUF_CNT  ];     /*端点1上传缓冲区大小*/
...
extern uint8_t USBSS_Endp_Clear_Frature( uint8_t dir_endp );
#ifdef __cplusplus
}
#endif
